...
// Dữ liệu mẫu (Sau này sẽ lấy từ Backend JS của bạn)
const CONVERSATIONS = [
  { id: "1", name: "Mom", avatar: "/avatars/mom.png", lastMsg: "Typing...", time: "Now", unread: 0, online: true, pinned: true },
  { id: "2", name: "Team Alpha", avatar: "", lastMsg: "Meeting at 5? Don't forget...", time: "10:42 AM", unread: 2, online: false, pinned: true },
  { id: "3", name: "John Doe", avatar: "", lastMsg: "You: Sent a photo 📷", time: "10:30 AM", unread: 0, online: true, pinned: false },
  { id: "4", name: "Service Support", avatar: "", lastMsg: "Your ticket #9283 has been...", time: "Yesterday", unread: 0, online: false, pinned: false },
];
      ...
      <div className="px-4 pb-4">
        <div className="relative">
          ...
          <Input 
            ...
            className="pl-9 bg-slate-100/50 border-none h-10 focus-visible:ring-1 focus-visible:ring-slate-200"
          />
        </div>
      </div>
      ...
      <ScrollArea className="flex-1">
        <div className="px-2 pb-4">
          ...
          <div className="px-3 mb-2">
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Pinned</span>
          </div>
...
function ChatCard({ chat }: { chat: typeof CONVERSATIONS[0] }) {
  return (
    <div className="flex items-center gap-3 p-3 hover:bg-slate-50 rounded-xl cursor-pointer group transition-all relative">
      <div className="relative">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex justify-between items-center">
          <p className={`text-[13px] truncate pr-2 ${chat.unread > 0 ? "text-slate-900 font-medium" : "text-slate-500"}`}>
            {chat.lastMsg}
          </p>
          {chat.unread > 0 && (
